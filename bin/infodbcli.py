...
def parse_args(argv):
    ...
    subparser_links = subparsers.add_parser("links", help="Utilities for work with Links | get")
    subparser_links.add_argument("--action", type=str, help="Possible actions: list")
